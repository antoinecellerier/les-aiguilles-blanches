...
8. **`art-review`** — invoke when designing new visual elements (sprites, textures, UI components) or testing responsive layout across viewports, to validate style compliance early, before implementation.
