...
- Gate width narrows with difficulty: L4 (5 tiles, 8 gates), L5 (4 tiles, 10 gates), L10 (5 tiles, 10 gates super-G).
...
- **Regular runs**: player skis on their own groomed piste. Slalom gates generated by chance (Blue 30% / Red 50% / Black 70%), with count (4-8) and width (5-6 tiles) scaling with rank. Gate positions are clamped to stay within ski physics traversal range.
