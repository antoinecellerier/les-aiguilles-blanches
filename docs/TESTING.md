...
./run-tests.sh --browser chromium --screenshots  # Keep screenshot files
...
E2E collection also uses previous-run duration history (`.pytest-e2e-durations.json`) to start slower tests earlier.
