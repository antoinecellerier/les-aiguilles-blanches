...
- MenuScene god class (1507 lines, 34 methods): extract wildlife animation controller, overlay/form manager. Terrain renderer extracted to `MenuTerrainRenderer.ts`.
