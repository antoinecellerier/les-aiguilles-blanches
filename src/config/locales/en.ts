...
const en: Record<string, string> = {
  ...
  levelComplete: "Run Complete!",
  levelFailed: "Run Failed",
  tryAgain: "Try Again",
  coverage: "Coverage",
  time: "Time",
  ...
  tutorialWelcome: "🏔️ I'm Jean-Pierre, head groomer. Drive around the piste — use {keys} or ↑↓←→.",
  tutorialWelcomeTouch: "🏔️ I'm Jean-Pierre, head groomer. Drive around the piste — use the D-pad on the left.",
  tutorialWelcomeGamepad: "🏔️ I'm Jean-Pierre, head groomer. Drive around the piste — use the left stick or D-pad.",
  // UNUSED   tutorialControls: "🎮 To move the groomer, use {keys} or the arrow keys ↑↓←→.",
  // UNUSED   tutorialControlsTouch: "🎮 To move the groomer, use the D-pad ◀▲▼▶ on the left.",
  // UNUSED   tutorialControlsGamepad: "🎮 To move the groomer, use the left stick or D-pad.",
  // UNUSED   tutorialMove: "➡️ Go on, try it! Move around the piste — all the white snow needs grooming.",
  // UNUSED   tutorialGroomIntro: "✅ Nice! Now let's learn to groom.",
...
changelog_20260211: "⛷️ Ski run after grooming\n🎯 Grooming quality\n🏔️ Color-coded steep zones\n🏗️ Terrain park and tricks",
  ...
  dailyRuns_dailyShift: "Daily Shift",
  dailyRuns_randomRun: "Random Run",
  dailyRuns_rank: "Rank",
  dailyRuns_seed: "Seed",
  // UNUSED   dailyRuns_start: "Start Contract",
  dailyRuns_locked: "Complete all runs to unlock",
  dailyRuns_lockedShared: "Complete all runs to unlock Daily Runs and play this shared piste",
  // UNUSED   dailyRun_levelName: "Contract",
  dailyRun_levelTask: "Groom the piste to target coverage",
  dailyRuns_briefing: "Briefing",
  dailyRuns_target: "Target",
  dailyRuns_timeLimit: "Time",
  dailyRuns_weather_clear: "Clear skies",
  dailyRuns_weather_light_snow: "Light snowfall",
  dailyRuns_weather_storm: "Storm conditions",
  dailyRuns_night: "Night shift",
  dailyRuns_day: "Day shift",
  rank_green: "Green",
  rank_blue: "Blue",
  rank_red: "Red",
  rank_black: "Black",
  ...
  share: "Share",
  copied: "Link copied!",
  playSharedSeed: "Shared Run",
  dailyRunBriefingJP: "This piste needs prep before the lifts open. Get it done.",
  dailyRunBriefingThierry: "Watch yourself out there — steep sections and unstable snow. Stay sharp.",
  dailyRunBriefingMarie: "It's going to be a cold one tonight. Come warm up at the restaurant if you need to.",
  dailyRunBriefingEmilie: "Another day, another piste. Try to beat my time on this one!",
};
