...
const tr: Record<string, string> = {
  subtitle: "Pist Bakım Simülatörü",
  ...
  fullscreenHint: "Tam ekran için F'ye bas",
  ...
  showFps: "FPS göster",
  showDebug: "Hata Ayıklama",
  skiStyle: "Stil",
  skiTricks: "Hareketler",
  skiBestCombo: "En iyi kombo",
  ...
  pause: "Duraklat",
  keyboard: "Klavye",
  clickToRebind: "Değiştirmek için tıkla",
  pressKey: "Bir tuşa bas...",
  pressGamepadButton: "Gamepad düğmesine bas...",
  ...
  connectGamepadDiag: "Test için bir kumanda bağla",
  ...
  howToPlayMoveTouch: "Sanal D-pad'i kullan",
  ...
  winchAttached: "🔗 Vinç bağlı! Yardım için {winchKey} basılı tut.",
  winchActive: "VİNÇ",
  // UNUSED winchHint: "Vinç kullanmak için ankraj direğinin yanında {winchKey} bas",
  // UNUSED winchHintTouch: "Vinç için 🔗 basılı tut",
  ...
  levelComplete: "Pist Tamamlandı!",
  levelFailed: "Pist Başarısız",
  tryAgain: "Tekrar Dene",
  coverage: "Kapsam",
  time: "Süre",
  // UNUSED rating: "Değerlendirme",
  nextLevel: "Sonraki Pist",
  // UNUSED replay: "Tekrarla",
  // UNUSED pressContinue: "Devam için boşluk tuşuna bas veya dokun",
  ...
  tutorialWelcome: "🏔️ Jean-Pierre, baş pistçi. Pistte dolaş — {keys} veya ↑↓←→ kullan.",
  tutorialWelcomeTouch: "🏔️ Jean-Pierre, baş pistçi. Pistte dolaş — soldaki D-pad'i kullan.",
  tutorialWelcomeGamepad: "🏔️ Jean-Pierre, baş pistçi. Pistte dolaş — sol çubuk veya D-pad kullan.",
  // UNUSED     tutorialControls: "🎮 Kar ezme aracını hareket ettirmek için {keys} veya ok tuşlarını ↑↓←→ kullan.",
  // UNUSED     tutorialControlsTouch: "🎮 Kar ezme aracını hareket ettirmek için soldaki D-pad'i ◀▲▼▶ kullan.",
  // UNUSED     tutorialControlsGamepad: "🎮 Kar ezme aracını hareket ettirmek için sol çubuk veya D-pad kullan.",
  // UNUSED     tutorialMove: "➡️ Haydi, dene! Pistte hareket et — tüm beyaz kar bakıma ihtiyaç duyuyor.",
  // UNUSED     tutorialGroomIntro: "✅ Güzel! Şimdi pist bakımını öğrenelim.",
  ...
  level_marmottesTask: "Başlangıç pistini hazırla",
  level_chamoisName: "Mavi Pist - Le Chamois",
  level_chamoisTask: "Açılıştan önce verimli çalış",
  level_airZoneName: "Snowpark - Air Zone",
  level_airZoneTask: "Freestyle elemanlarını hazırla",
  level_aigleName: "Kırmızı Pist - L'Aigle",
  level_aigleTask: "Dik arazide çalış, yakıta dikkat",
  level_glacierName: "Kırmızı Pist - Le Glacier",
  level_glacierTask: "Dik yamaçlarda vinç kullanmayı öğren",
  level_tubeName: "Half-pipe - Le Tube",
  level_tubeTask: "Yarışma için half-pipe bakımını yap",
  ...
  level_colDangereuxTask: "Yüksek riskli bölgeyi hazırla",
  level_tempeteName: "Fırtına - Kurtarma",
  level_tempeteTask: "Fırtınadan sonra pistleri temizle",
  level_coupeDesAiguillesName: "Coupe des Aiguilles - FIS Finali",
  level_coupeDesAiguillesTask: "Tüm pistleri yarışma için hazırla",

  // Hazards
  cliffFall: "⚠️ DİKKAT! Uçurumdan düştün! Görev başarısız.",
  ...
  level_glacierIntro: "Selam, ben Thierry — güvenlik sorumlusu. Le Glacier dik. Her ankrajı kontrol ettim. Vinç bağlamak için direğin yanında {winchKey} bas — ve lütfen, bırakma.",
  level_glacierIntroTouch: "Selam, ben Thierry — güvenlik sorumlusu. Le Glacier dik. Her ankrajı kontrol ettim. Direğin yanında vinç düğmesine dokun — ve lütfen, bırakma.",
  ...
  marieWelcome: "Chez Marie'de ısınmaya gel. Güzel bir tartiflette!",
  ...
  changelog_20260216: "🎲 Günün Pistleri",
...
changelog_20260211: "⛷️ Hazırlama sonrası kayak inişi\n🎯 Hazırlama kalitesi\n🏔️ Renk kodlu dik bölgeler\n🏗️ Park ve trick'ler",
  ...
  changelog_20260203: "🚜 Lansman: 9 pist, kayak okulu\n❄️ Pist bakımı, yakıt, çığlar\n🏆 Jenerik ve ilerleme",
  // Key names
  key_space: "BOŞLUK",
  key_shift: "SHIFT",
  key_ctrl: "CTRL",
  ...
  key_esc: "ESC",
  key_del: "SİL",
  dailyRuns: "Günün Pistleri",
  dailyRuns_dailyShift: "Günlük Vardiya",
  dailyRuns_randomRun: "Rastgele Sürüş",
  dailyRuns_rank: "Sıralama",
  dailyRuns_seed: "Tohum",
  // UNUSED   dailyRuns_start: "Sözleşmeyi Başlat",
  dailyRuns_locked: "Kilidini açmak için tüm pistleri tamamlayın",
  dailyRuns_lockedShared: "Tüm pistleri tamamlayarak Günlük Turları açın ve bu paylaşılan pisti oynayın",
  ...
  dailyRuns_target: "Hedef",
  dailyRuns_timeLimit: "Süre",
  dailyRuns_weather_clear: "Açık hava",
  dailyRuns_weather_light_snow: "Hafif kar yağışı",
  dailyRuns_weather_storm: "Fırtına koşulları",
  dailyRuns_night: "Gece vardiyası",
  dailyRuns_day: "Gündüz vardiyası",
  rank_green: "Yeşil",
  rank_blue: "Mavi",
  rank_red: "Kırmızı",
  rank_black: "Siyah",
  ...
  playSharedSeed: "Paylaşılan tur",
  dailyRunBriefingJP: "Pist, liftler açılmadan hazır olmalı. Hadi başla.",
  dailyRunBriefingThierry: "Dikkat et orada — dik geçişler ve kararsız kar var. Tetikte ol.",
  dailyRunBriefingMarie: "Bu gece çok soğuk olacak. İhtiyacın olursa restorana gel, ısın biraz.",
  dailyRunBriefingEmilie: "Bir pist daha. Bakalım süreme yetişebilecek misin!"
};
