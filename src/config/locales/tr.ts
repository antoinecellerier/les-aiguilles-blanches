...
const tr: Record<string, string> = {
  ...
  tutorialControls: "🎮 Kar ezme aracını hareket ettirmek için {keys} veya ok tuşlarını ↑↓←→ kullan.",
  tutorialControlsTouch: "🎮 Kar ezme aracını hareket ettirmek için soldaki D-pad'i ◀▲▼▶ kullan.",
  tutorialControlsGamepad: "🎮 Kar ezme aracını hareket ettirmek için sol çubuk veya D-pad kullan.",
  ...
  tutorialGoal: "🎯 Açılıştan önce pistin en az %40'ını ezmelisin. Kayakçılar geliyor!",
