...
const sk: Record<string, string> = {
  ...
  connectGamepadDiag: "Pripojte ovládač na testovanie",
  ...
  winchActive: "NAVIJÁK",
  // UNUSED winchHint: "Stlačte {winchKey} pri kotviacom stĺpiku pre naviják",
  // UNUSED winchHintTouch: "Držte 🔗 pre naviják",
  ...
  // UNUSED pressContinue: "Stlačte medzerník alebo ťuknite pre pokračovanie",
  ...
  // UNUSED tutorialFuel: "⛽ Pozor — jazda spotrebúva palivo. Na misiách stavte na čerpacej stanici.",
