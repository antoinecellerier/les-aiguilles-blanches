...
const cs: Record<string, string> = {
  ...
  // UNUSED pressKey: "Stiskněte klávesu...",
  // UNUSED pressGamepadButton: "Stiskněte tlačítko gamepadu...",
  gamepadButtons: "Gamepad",
  // UNUSED saved: "Uloženo!",
  resetControls: "Obnovit vše",
  // UNUSED controlsReset: "Ovládání obnoveno!",
  ...
  steepWarningNoWinch: "⚠️ STRMÝ SVAH! Zpomalte a použijte servisní cesty k objíždění!",
  ...
  level_chamoisIntro: "Dobrá práce včera! JP vás posílá na modrou. Ukažte, že umíte víc než jen samety na zelené.",
  ...
  level_colDangereuxIntro: "Vysoké lavinové riziko na průsmyku — jedeme v protokolu PIDA. Držte se od zatížených zón a respektujte hranice.",
