...
const es: Record<string, string> = {
  ...
  tutorialGroomGoal: "📊 ¡Así se hace! Pisa al menos el 40% antes de abrir. ¡Los esquiadores llegan!",
  ...
  // UNUSED   tutorialGoal: "🎯 Hay que pisar al menos el 40% de la pista antes de abrir. ¡Los esquiadores llegan pronto!",
