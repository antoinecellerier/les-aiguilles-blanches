...
const sv: Record<string, string> = {
  ...
  tutorialWelcome: "🏔️ Jean-Pierre, chefspistvakt. Kör på pisten — använd {keys} eller ↑↓←→.",
  tutorialWelcomeTouch: "🏔️ Jean-Pierre, chefspistvakt. Kör på pisten — använd D-paden till vänster.",
  tutorialWelcomeGamepad: "🏔️ Jean-Pierre, chefspistvakt. Kör på pisten — använd vänster spak eller D-pad.",
