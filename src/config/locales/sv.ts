...
const sv: Record<string, string> = {
  ...
  tutorialGroomGoal: "📊 Precis! Preparera minst 40% innan öppning. Skidåkarna kommer!",
  ...
  // UNUSED   tutorialGoal: "🎯 Du måste preparera minst 40% av pisten innan öppning. Skidåkarna kommer!",
