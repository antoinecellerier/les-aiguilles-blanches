...
const fi: Record<string, string> = {
  ...
  showFps: "Näytä FPS",
  showDebug: "Virheenkorjaus",
  skiStyle: "Tyyli",
  skiTricks: "Temput",
  skiBestCombo: "Paras kombo",
  quitGame: "Lopeta peli",
  display: "Näyttö",
  displayWindowed: "Ikkuna",
  displayFullscreen: "Koko näyttö",
  displayBorderless: "Reunaton",
  ...
  pressKey: "Paina näppäintä...",
  pressGamepadButton: "Paina ohjaimen nappia...",
  noGamepad: "Ei peliohjain yhdistetty",
  gamepadButtons: "Ohjain",
  saved: "Tallennettu!",
  resetControls: "Palauta",
  controlsReset: "Ohjaus palautettu!",
  ...
  levelComplete: "Rinne valmis!",
  levelFailed: "Rinne epäonnistui",
  tryAgain: "Yritä uudelleen",
  coverage: "Kattavuus",
  time: "Aika",
  // UNUSED rating: "Arvosana",
  nextLevel: "Seuraava rinne",
  ...
  tutorialWelcome: "🏔️ Jean-Pierre, rinnepäällikkö. Aja rinteessä — käytä {keys} tai ↑↓←→.",
  tutorialWelcomeTouch: "🏔️ Jean-Pierre, rinnepäällikkö. Aja rinteessä — käytä D-padia vasemmalla.",
  tutorialWelcomeGamepad: "🏔️ Jean-Pierre, rinnepäällikkö. Aja rinteessä — käytä vasenta tikkua tai D-padia.",
  // UNUSED     tutorialControls: "🎮 Ohjaa rinnekonetta {keys}-näppäimillä tai nuolilla ↑↓←→.",
  // UNUSED     tutorialControlsTouch: "🎮 Ohjaa rinnekonetta D-padilla ◀▲▼▶ vasemmalla.",
  // UNUSED     tutorialControlsGamepad: "🎮 Ohjaa rinnekonetta vasemmalla tikulla tai D-padilla.",
  // UNUSED     tutorialMove: "➡️ Kokeile! Aja rinteessä — kaikki valkoinen lumi pitää tampata.",
  // UNUSED     tutorialGroomIntro: "✅ Hienoa! Nyt opetellaan tamppaamaan.",
  ...
  steepWarning: "⚠️ JYRKKÄ RINNE! Käytä vinssiä ({winchKey}) tai liu'u!",
  ...
  tauntSkiWipeout3: "Rinnepartio nauraa jo. He näkivät kaiken.",
  ...
  level_glacierIntro: "Hei, olen Thierry — turvallisuusvastaava. Le Glacier on jyrkkä. Olen tarkistanut jokaisen ankkurin. Paina {winchKey} tolpan lähellä kiinnittääksesi vinssin — ja ole kiltti, älä päästä irti.",
  level_glacierIntroTouch: "Hei, olen Thierry — turvallisuusvastaava. Le Glacier on jyrkkä. Olen tarkistanut jokaisen ankkurin. Paina vinssinappia tolpan lähellä — ja ole kiltti, älä päästä irti.",
  ...
  changelog_20260216: "🎲 Päivän rinteet",
...
changelog_20260211: "⛷️ Laskettelulasku tamppauksen jälkeen\n🎯 Tamppauksen laatu\n🏔️ Värikoodatut jyrkät vyöhykkeet\n🏗️ Parkki ja trikit",
  ...
  key_esc: "ESC",
  key_del: "DEL",
  dailyRuns: "Päivän rinteet",
  dailyRuns_dailyShift: "Päivävuoro",
  dailyRuns_randomRun: "Satunnainen ajo",
  dailyRuns_rank: "Sijoitus",
  dailyRuns_seed: "Siemen",
  // UNUSED   dailyRuns_start: "Aloita sopimus",
  dailyRuns_locked: "Läpäise kaikki rinteet avataksesi",
  dailyRuns_lockedShared: "Suorita kaikki rinteet avataksesi päivittäiset kierrokset ja pelataksesi tämän jaetun rinteen",
  // UNUSED   dailyRun_levelName: "Sopimus",
  dailyRun_levelTask: "Kunnostakaa rinne tavoitepeittoon",
  dailyRuns_briefing: "Toimeksianto",
  dailyRuns_target: "Tavoite",
  dailyRuns_timeLimit: "Aika",
  dailyRuns_weather_clear: "Selkeä sää",
  dailyRuns_weather_light_snow: "Heikko lumisade",
  dailyRuns_weather_storm: "Myrskyolosuhteet",
  dailyRuns_night: "Yövuoro",
  dailyRuns_day: "Päivävuoro",
  rank_green: "Vihreä",
  rank_blue: "Sininen",
  rank_red: "Punainen",
  rank_black: "Musta",
  ...
  playSharedSeed: "Jaettu kierros",
  dailyRunBriefingJP: "Rinne pitää olla valmis ennen hissien avaamista. Töihin.",
  dailyRunBriefingThierry: "Ole varovainen tuolla — jyrkkiä osuuksia ja epävakaata lunta. Pysy valppaana.",
  dailyRunBriefingMarie: "Tästä tulee kylmä yö. Pistäydy ravintolassa lämmittelemässä, jos tarvitsee.",
  dailyRunBriefingEmilie: "Taas yksi rinne. Yritäpä päihittää aikani!"
};
