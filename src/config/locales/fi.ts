...
const fi: Record<string, string> = {
  ...
  winchHintTouch: "Pidä 🔗 vinssille",
  accessPath: "Huoltotie",
  toPiste: "Rinteeseen",
  ...
  tutorialFuel: "⛽ Varoitus — ajaminen kuluttaa polttoainetta. Tehtävissä pysähdy tankkaamaan.",
  ...
  level_chamoisIntro: "Hyvin tehty eilen! Jean-Pierre lähettää sinut siniselle rinteelle. Näytä ettei sinusta ole vain vihreälle.",
  ...
  level_tubeIntro: "Kilpailu huomenna! Half-pipen pitää olla moitteeton.",
  level_verticaleIntro: "Yöoperaatio La Verticalella. Käytä vinssiä.",
  level_colDangereuxIntro: "Varovasti, lumivyöryalue on herkkä tänään.",
