...
const it: Record<string, string> = {
  ...
  levelComplete: "Pista completata!",
  levelFailed: "Pista fallita",
  tryAgain: "Riprova",
  coverage: "Copertura",
  time: "Tempo",
  // UNUSED target: "Obiettivo",
  // UNUSED rating: "Voto",
  nextLevel: "Prossima pista",
  ...
  quit: "Esci",
  menu: "Menu",
  levelSelect: "Mappa delle piste",
  locked: "Chiusa",
   completeToUnlock: "Completa {name} per sbloccare",
  tutorial: "Scuola di sci",
  ...
  creditsDevelopedWith: "Sviluppato con",
  creditsArtDirection: "Direzione Artistica",
  creditsRetroInspiration: "Un omaggio ai classici retrò come SkiFree",
  creditsInspiredBy: "Ispirato da",
  creditsGroomers: "I gattisti della Savoia",
  creditsDedication: "Per le squadre notturne che preparano le piste mentre dormiamo",
  creditsThanks: "Grazie per aver giocato!",
  creditsSeeYou: "A presto sulle piste!",
  creditsLine: "Dai, ragazzo. Il sole sorge. La montagna è pronta.",
  playAgain: "Rigiocare",
  ...
  tutorialGroomGoal: "📊 Ecco! Batti almeno il 60% prima dell'apertura. Gli sciatori arrivano!",
  ...
  // UNUSED   tutorialGoal: "🎯 Devi battere almeno il 60% della pista prima dell'apertura. Gli sciatori stanno arrivando!",
  ...
  changelog_20260223_date: "23 febbraio 2026",
  changelog_20260223: "📲 Installa sul tuo dispositivo per giocare offline",
...
changelog_20260211: "⛷️ Discesa sci dopo la preparazione\n🎯 Qualità della preparazione\n🏔️ Zone ripide colorate\n🏗️ Terrain park e trick",
  ...
  dailyRuns_locked: "Completa tutte le piste per sbloccare",
  dailyRuns_lockedShared: "Completa tutte le piste per sbloccare le Corse giornaliere e giocare questa pista condivisa",
