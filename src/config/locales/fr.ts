...
const fr: Record<string, string> = {
  ...
  // UNUSED pressKey: "Appuyez sur une touche...",
  // UNUSED pressGamepadButton: "Appuyez sur un bouton de manette...",
  gamepadButtons: "Manette",
  // UNUSED saved: "Sauvegardé !",
  resetControls: "Réinitialiser",
  // UNUSED controlsReset: "Contrôles réinitialisés !",
