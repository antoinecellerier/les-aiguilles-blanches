...
export const TRANSLATIONS: Record<SupportedLanguage, Record<string, string>> = {
    fr: {
        ...
        tutorialControls: "🎮 CONTRÔLES : Utilise {keys} ou les flèches ↑↓←→ pour déplacer la dameuse.",
        ...
        tutorialGroomAction: "❄️ DAMER : Maintiens {groomKey} tout en te déplaçant pour transformer la neige en piste damée.",
        tutorialGroomActionTouch: "❄️ DAMER : Maintiens le bouton ❄️ à droite tout en te déplaçant pour damer la neige.",
        tutorialGroomActionGamepad: "❄️ DAMER : Maintiens {groomKey} tout en te déplaçant pour transformer la neige en piste damée.",
        tutorialCoverage: "📊 Tu vois ? La neige devient plus lisse ! Continue à damer la piste.",
        tutorialHUD: "📈 INTERFACE : En haut à gauche : ⛽ Carburant, 💪 Endurance, ❄️ Couverture. En haut à droite : 🎯 Objectif.",
        tutorialGoal: "🎯 OBJECTIF : Dame au moins 40% de la piste. Les skieurs arrivent bientôt !",
        ...
        changelog_20260211: '🎮 Navigation clavier/manette dans les paramètres\n🎚️ Réglage de sensibilité du mouvement (25%–200%)',
    ...
    en: {
        ...
        tutorialControls: "🎮 CONTROLS: Use {keys} or arrow keys ↑↓←→ to move the groomer.",
        ...
        tutorialGroomAction: "❄️ GROOMING: Hold {groomKey} while moving to transform snow into a smooth piste.",
        tutorialGroomActionTouch: "❄️ GROOMING: Hold the ❄️ button on the right while moving to groom the snow.",
        tutorialGroomActionGamepad: "❄️ GROOMING: Hold {groomKey} while moving to transform snow into a smooth piste.",
        tutorialCoverage: "📊 See? The snow becomes smoother! Keep grooming the piste.",
        tutorialHUD: "📈 HUD: Top-left: ⛽ Fuel, 💪 Stamina, ❄️ Coverage. Top-right: 🎯 Target.",
        tutorialGoal: "🎯 GOAL: Groom at least 40% of the piste. Skiers are coming!",
        ...
        changelog_20260211: '🎮 Keyboard & gamepad navigation in Settings\n🎚️ Movement sensitivity setting (25%–200%)',
    ...
    de: {
        ...
        tutorialGroomActionGamepad: "❄️ PRÄPARIEREN: Halte {groomKey} während der Fahrt zum Präparieren.",
        tutorialCoverage: "📊 Siehst du? Der Schnee wird glatter! Präpariere weiter!",
        tutorialHUD: "📈 ANZEIGE: Oben links: ⛽ Kraftstoff, 💪 Ausdauer, ❄️ Abdeckung. Oben rechts: 🎯 Ziel.",
        tutorialGoal: "🎯 ZIEL: Präpariere mindestens 40% der Piste. Die Skifahrer kommen!",
        ...
        changelog_20260211: '🎮 Tastatur- & Gamepad-Navigation in den Einstellungen\n🎚️ Bewegungsempfindlichkeit (25%–200%)',
    ...
    it: {
        ...
        tutorialGroomActionGamepad: "❄️ BATTIPISTA: Tieni {groomKey} mentre ti muovi per preparare.",
        tutorialCoverage: "📊 Vedi? La neve diventa più liscia! Continua a battere!",
        tutorialHUD: "📈 HUD: In alto a sinistra: ⛽ Carburante, 💪 Resistenza, ❄️ Copertura. In alto a destra: 🎯 Obiettivo.",
        tutorialGoal: "🎯 OBIETTIVO: Batti almeno il 40% della pista. Gli sciatori stanno arrivando!",
        ...
        changelog_20260211: '🎮 Navigazione tastiera e gamepad nelle impostazioni\n🎚️ Sensibilità del movimento (25%–200%)',
    ...
    es: {
        ...
        tutorialGroomActionGamepad: "❄️ PISAR: Mantén {groomKey} mientras te mueves para preparar.",
        tutorialCoverage: "📊 ¿Ves? ¡La nieve se vuelve más lisa! ¡Sigue pisando!",
        tutorialHUD: "📈 HUD: Arriba izquierda: ⛽ Combustible, 💪 Resistencia, ❄️ Cobertura. Arriba derecha: 🎯 Objetivo.",
        tutorialGoal: "🎯 META: Pisa al menos el 40% de la pista. ¡Los esquiadores vienen!",
        ...
        changelog_20260211: '🎮 Navegación por teclado y mando en los ajustes\n🎚️ Sensibilidad del movimiento (25%–200%)',
